...
The standalone `docs-site` artifact contains the responsive Asset Atlas downloads page with direct GitHub Release naming conventions, source and checksum links, changelog, upstream comparison, support card, local branded image assets, and no DzGreen-only runtime references.
...
| GitHub Pages artifact | Passed; local assets present and DzGreen-only references removed |
