...
**النسخة:** Premium Preview v1.3.15-dzgreen.15 — حزمة Windows محلية متحققة
**إيداع Phase 2 المحلي:** `40484fc8691001715a2cd7fb046cc770a7242e5a`
**المالك:** dzgreeno  
...
| العنصر | القيمة |
| --- | --- |
| اسم الحزمة | `AssetRipper-DzGreen-Premium-v1.3.15-dzgreen.15-phase2-preview-Windows-x64.zip` |
| الحجم | 91,082,148 بايت |
| SHA-256 | `77652d5bf337b2e1bc9353186b54cd0bd740c16314a50f007ee636d14553ee9a` |
| فحص الأرشيف | نجح `unzip -t` دون أخطاء |
| ملفات مرفقة داخل الحزمة | ملف تشغيل Premium، ترخيص GPL-3.0، README المصدر، ووثيقة هندسة الاسترداد المصرح به |
| حالة النشر | محلي فقط؛ لا يوجد رفع مصدر أو ZIP أو Release إلى GitHub. |
